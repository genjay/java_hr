drop procedure if exists p_tdoc_overwork_del;

delimiter $$ 

create procedure p_tdoc_overwork_del
(
...
*/
set err_code=0; set outRwid=0; set outMsg='p_tdoc_overwork_delxx 執行中';
...
if err_code=0 && 1 then # 90
	...
	delete From tdoc_overwork  
	Where exists (Select * from tmpProc01 x where tdoc_overwork.rwid=x.doc_rwid
	 and ifnull(x.note,'')='');
