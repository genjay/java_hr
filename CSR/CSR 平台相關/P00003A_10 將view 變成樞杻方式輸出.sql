...
drop procedure if exists P00003A_10$$
CREATE DEFINER=`sa`@`%` PROCEDURE `P00003A_10`
(IN inSTR_A TEXT,IN inSTR_B text,IN inSTR_C text,IN inSTR_D varchar(255),inSTR_E varchar(255)
,out sOUT text)
BEGIN
